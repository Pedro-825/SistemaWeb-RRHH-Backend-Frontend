package com.rrhh.Modulos.CU5_Reporte.Infrastructure.export;
...
@Component("reporteExportFactory")
public class ReporteExportFactory implements ExportAbstractFactory {
